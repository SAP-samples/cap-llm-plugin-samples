sap.ui.define([
    ...
    return Controller.extend("harmonizedragappui.controller.LeftScreen", {
        ...
        onUploadFileBtnSelect: function(oEvent){
            ...
            this.fileUploadFragment ??= this.loadFragment({
                name: "harmonizedragappui.view.FileUploading"
            });
        ...
        onManageFileBtnSelect: function(){
            ...
            this.fileManagementFragment ??= this.loadFragment({
                name: "harmonizedragappui.view.FileManagement"
            });
